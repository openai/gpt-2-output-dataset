...
# train
d_webtext <- fread("plot/webtext_freq_power_1k_train.csv")
d_webtext$source <- "webtext"
p <- ggplot(d_webtext, aes(freq, power)) + geom_smooth()
ggsave("plot/webtext_freq_power_1k_smooth_train.pdf", plot=p)

# opt
d_webtext <- fread("plot/webtext_freq_power_1k_opt.csv")
d_webtext$source <- "webtext"
p <- ggplot(d_webtext, aes(freq, power)) + geom_smooth()
ggsave("plot/webtext_freq_power_1k_smooth_opt.pdf", plot=p)

# valid
d_webtext <- fread("plot/webtext_freq_power_1k_valid.csv")
d_webtext$source <- "webtext"
p <- ggplot(d_webtext, aes(freq, power)) + geom_smooth()
ggsave("plot/webtext_freq_power_1k_smooth_valid.pdf", plot=p)

# test
d_webtext <- fread("plot/webtext_freq_power_1k_test.csv")
d_webtext$source <- "webtext"
p <- ggplot(d_webtext, aes(freq, power)) + geom_smooth()
ggsave("plot/webtext_freq_power_1k_smooth_test.pdf", plot=p)
