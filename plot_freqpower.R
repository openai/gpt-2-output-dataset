...
d_webtext_gpt2 <- fread("plot/webtext.test.model=gpt2.freq_power_1k.csv")
d_webtext_medium <- fread("plot/webtext.test.model=gpt2-medium.freq_power_1k.csv")
d_webtext_large <- fread("plot/webtext.test.model=gpt2-large.freq_power_1k.csv")
d_webtext_xl <- fread("plot/webtext.test.model=gpt2-xl.freq_power_1k.csv")
...
d_webtext_c <- rbindlist(list(d_test_gpt2, d_test_medium, d_test_large, d_webtext_xl))
p_webtext_c <- ggplot(d_webtext_c, aes(freq, power)) +
  geom_smooth(aes(linetype = model, fill = model, colour = model))
ggsave("plot/webtext.test.4models.freq_power_1k.pdf", plot=p_webtext_c)
